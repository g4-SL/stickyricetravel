(function($){var settings={prependTo:'nav',switchWidth:996,topOptionText:'Select a page:'},menuCount=0,uniqueLinks=[];function goTo(url){document.location.href=url;}
...
if(isMobile()&&menuExists()){$('.mnav').show();}
if(!isMobile()&&menuExists()){$('.mnav').hide();$menus.show();$("#navi").center();}}
