	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-adventures-mount-kinabalu-camping.jpg" alt="Mt Kinabalu Camping Sabah Borneo"/>
			</li>
		</ul>
	</div>
		...
		<div class="container hd">
			...
			<div class="sixteen columns big_title">
				<ul class="brc">
					...
					<li>3D2N Kinabalu Camping</li>
				</ul>
				<h1>3D2N Kinabalu Camping</h1>
			</div>	
				...
				<div class="nine columns">
					...
					<table class="tbl_p">
						<tr>
							...
							<td>
								You will be sleeping in tents provided with sleeping mat, sleeping bags and warm blanket.
							</td>
						</tr>
						 <tr>
							<td class="he">Food</td>
					...
					<table class="tbl_p">
						<tbody>
							...
							<tr>
								<td class="col_label"><img src="c/day3.png" alt="Day 3 - Day Three" /></td>
								<td>
					...
					<table class="tbl_p">
						<tbody>
							...
							<tr>
								<td>
									Transfer to/from Kota Kinabalu, tent with sleep mats and sleeping bag and blanket, meals, Sticky Rice Travel nature guide, entrance fees, drinking water, coffee &amp; tea, snacks.
								</td>
								<td>
							...
							<tr>
								<td colspan="2">
									Couples, families, and other travellers keen on camping in nature, hiking and waterfall.  
								</td>
							</tr>
						</tbody>
					</table>
			...
			<div class="seven columns bp">
				...
				<img src="c/adventures-mount-kinabalu-camping/1-400.jpg" alt="Mt Kinabalu, Sabah Borneo - Frog" />
				<img src="c/adventures-mount-kinabalu-camping/2-400.jpg" alt="Mt Kinabalu, Sabah Borneo - Nature" />
				<img src="c/adventures-mount-kinabalu-camping/3-400.jpg" alt="Mt Kinabalu, Sabah Borneo - Snake" />
				<img src="c/adventures-mount-kinabalu-camping/4-400.jpg" alt="Mt Kinabalu, Sabah Borneo - River" />
				<img src="c/adventures-mount-kinabalu-camping/5-400.jpg" alt="Mt Kinabalu, Sabah Borneo - Nature" />
			</div>
...
<script>
	populateSidebar("Kinabalu National Park", "3D2N Kinabalu Camping");
</script>