	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-adventures-jesselton-hotel.jpg" alt="Jesselton Hotel, located at Kota Kinabalu Sabah"/>
		...
		<div class="container hd">
			...
			<div class="sixteen columns big_title">
				<ul class="brc">
					...
					<li>Jesselton Hotel</li>
				</ul>
				<h1>Jesselton Hotel</h1>
			</div>	
			...
			<div class="seven columns bp">
				...
				<img src="c/adventures-jesselton-hotel/4-400.jpg" alt="Jesselton Hotel" />
				<img src="c/adventures-jesselton-hotel/5-400.jpg" alt="Jesselton Hotel" />
				<p><i>*Photo credit to Jesselton Hotel</i></p>
			</div>
...
<script>
	populateSidebar("Kota Kinabalu", "Jesselton Hotel");
</script>