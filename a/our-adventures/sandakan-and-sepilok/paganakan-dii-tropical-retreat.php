	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-adventures-paganakan-dii-tropical-retreat.jpg" alt="Paganakan Dii Tropical Retreat"/>
	...
	<nav></nav><section>	
		...
		<div class="container hd">
			...
			<div class="sixteen columns big_title">
				...
				<h1>Paganakan Dii Tropical Retreat</h1>
			</div>	
			...
			<div class="seven columns bp">
				...
				<p><i>*Photo credit to Paganakan Dii Tropical Retreat</i></p>
			</div>
...
<script>
	populateSidebar("Sandakan & Sepilok", "Paganakan Dii Tropical Retreat");
</script>