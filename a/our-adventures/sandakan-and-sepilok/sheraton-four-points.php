	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-adventures-sheraton-four-points.jpg" alt="Sheraton Four Points"/>
		...
		<div class="container hd">
			...
			<div class="sixteen columns big_title">
				<ul class="brc">
					...
					<li>Sheraton Four Points</li>
				</ul>
				<h1>Sheraton Four Points</h1>
			</div>	
			...
			<div class="seven columns bp">
				...
				<img src="c/adventures-sheraton-four-points/5-400.jpg" alt="Sheraton Four Points">
				<p><i>*Photo credit to Sheraton Four Points</i></p>
			</div>
...
<script>
	populateSidebar("Sandakan & Sepilok", "Sheraton Four Points");
</script>