	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-adventures-kayaking-rafting.jpg" alt="Rainforest Kayaking &amp; Bamboo Rafting"/>
		...
		<div class="container hd">
			...
			<div class="sixteen columns big_title">
				<ul class="brc">
					...
					<li>Rainforest Kayaking or Bamboo Rafting</li>
				</ul>
				<h1>Rainforest Kayaking or Bamboo Rafting</h1>
			</div>	
			...
			<div class="seven columns bp">
				...
				<img src="c/adventures-kayaking-rafting/2-400.jpg" alt="Rainforest Kayaking &amp; Bamboo Rafting" />
				<img src="c/adventures-kayaking-rafting/6-400.jpg" alt="Rainforest Kayaking &amp; Bamboo Rafting" />
			</div>
...
<script>
	populateSidebar("Kuching", "Rainforest Kayaking or Bamboo Rafting");
</script>