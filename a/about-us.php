	...
	<nav></nav><section>	
		<div class="container">
			...
			<div class="twelve columns twelve-six-col-res">
				...
				<h3><i class="ion-clipboard ionic"></i>Tailor-made trips</h3>
				<p>
				...
				<h3><i class="ion-map ionic"></i>Niche travel</h3>
				<p>
				...
				<h3><i class="ion-ios-lightbulb-outline ionic"></i>Expert knowledge and insider access</h3>
				<p>
				...
				<h3><i class="ion-earth ionic"></i>Responsible travel</h3>
				<p>
			...
			<div class="six columns mt-icon">
				...
				<a href="../meet-the-team#eva-bella"><img src="./c/the-team/icon/eva-bella.jpg" title="Eva Bella"/></a>
				<a href="../meet-the-team#junaidi-onik"><img src="./c/the-team/icon/junaidi-onik.jpg" title="Junaidi Onik"/></a>
				<a href="../meet-the-team#yoksan-julbid"><img src="./c/the-team/icon/yoksan-julbid.jpg" title="Yoksan bin Julbid"/></a>
			...
			<div class="sixteen columns"><h1>Customer Testimonials</h1></div>
