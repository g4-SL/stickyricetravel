	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-our-adventures.jpg" alt="Tambatuon"/>
...
<!-- 			<div style="width:50%; margin:0 auto">
			...
			<div class="tabs tabs-style-linebox">
			    <ul class="tab-links">
			        <li class="active"><a href="#sabah">Sabah</a></li>
			    ...
			    <div class="tab-content">
			        ...
			        <div id="sarawak" class="tab">
						<div class="eight columns">
							<div class="pp2">
								<a href="our-adventures/kudat" title="Bako National Park"><img src="c/adventures/kudat.jpg" class="img1" alt="Kudat" /></a>
							</div>					
						</div>	

						<div class="eight columns">
							<div class="pp2">
								<a href="our-adventures/maliau-basin" title="Kuching"><img src="c/adventures/maliau-basin.jpg" class="img1" alt="Maliau Basin" /></a>
							</div>	
						</div>	
						...
						<div class="eight columns">
							<div class="pp2">
								<a href="our-adventures/orou-sapulot" title="Mulu National Park"><img src="c/adventures/sapulot-country-adventure.jpg" class="img1"  alt="Orou Sapulot - Murut Country Adventure" /></a>
							</div>	
						</div>	

						<div class="eight columns">
							<div class="pp2">
								<a href="our-adventures/ulu-ai-experiences" title="Ulu Ai Experiences"><img src="c/adventures/sandakan-and-sepilok.jpg" class="img1" alt="Sandakan &amp; Sepilok" /></a>
							</div>			
						</div>	
