	<div id="sly" class="ei-slider">
		<ul class="ei-slider-large">
			<li>
				<img src="c/large/www-adventures-tabin.jpg" alt="leopard cat/felis bengalensis" />
	...
	<nav></nav><section>	
		...
		<div class="container nd">
			...
			<div class="nine columns">
				<h1>3D2N Tabin Wildlife Adventure</h1>
			</div>			
			...
			<div class="nine columns">
				...
				<table class="tbl_p">
					<tr>
						...
						<td>
							10 River Lodge &amp; 10 Hill Lodge with private bathroom and shower (hot shower), air-conditioning and private balcony
						</td>
					</tr>
					 <tr>
						<td class="he">Food</td>
					 ...
					 <tr>
						...
						<td>Eating lounge (set time for meals), electricity via generator 24/7, wifi at eating lounge (ebbs and flow)</td>
					</tr>
					 <tr>
						<td class="he">Guides</td>
						<td>
							You will be accompanied by in-house guides at the resort for walks and 4x4 safaris surrounding the property for wildlife and nature observation.
							<br /><br />
				...
				<table class="tbl_p">
					<tbody>
						...
						<tr>
							<td>
								Accommodation, meals, coffee, tea &amp; drinking water, conservation fees, return transfers from Lahad Datu airport, guide and activities.
							</td>
							<td>
								Travel to Lahad Datu, additional activities upon request.
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								Head lamp, mosquito repellent, sunscreen, hat, sunglasses, binocular, dry bag, money (no ATM), water bottle, toiletries, basic first aid kit, leech socks, swimming attire.
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								Couples, families, and other travellers keen on wildlife and river cruise. We consider Tabin Wildlife Resort a comfortable jungle lodge with an exclusive destination that is a must for travelers keen on spotting wildlife without too much hiking (some hiking but all safaris are on 4x4 drives). The areas surrounding the lodge is also very popular for birders.  
							</td>
						</tr>
					</tbody>
				</table>				
