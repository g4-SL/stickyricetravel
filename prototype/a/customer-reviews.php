	...
	<nav></nav><section>	
		<div class="container nd">
			...
			<div class="seven columns">
				...
				<form method="post" name="frm_cmt" id="frm_cmt" class="zn_form form contact-form">
					...
					<fieldset>
							...
							<div class="control-group ">
								<label for="contact-details">Comments/Reviews:<span class="required">*</span></label>
								<textarea id="contact-details" rows="30" cols="50" name="message" class="input textarea zn_required_field"></textarea>
							</div>

							<div class="control-group">
								<div class="controls">
									<input class="button" id="submit-form" type="submit" name="submit" value="Send" style="float:left;width:95%">
								</div>
							</div>								
			...
			<hr class="lig">
				...
				<p><b>Dec 1, 2014 by Cecile Schneider</b></p>

			<br /><br />
			<hr class="lig">

				<h2>Amazing Adventures with Sticky Rice</h2>
				<p>
				...
				<p><b>Mar 13, 2014 by Jim and Katie Thomsen</b></p>
			...
			<hr class="lig">
				...
				<p>
					<b>Sep 08, 2013 by brijinder singh</b>
				</p>
